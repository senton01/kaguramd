...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                kagura.sendMessage(m.chat, { image: { url: 'https://i.postimg.cc/285jhWbY/IMG-20220611-WA0005.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n Harga Sewa Bot\n⭔ Permanen 7k\n⭔ 1bulan 5k\n⭔ 1 minggu 2k\n\n Premium Price Bot\n⭔ 8k per User\n\nPayment can be via qris/dana/gopay\n\nFor more details, you can chat with the owner\nhttps://wa.me/6281522528724 (Owner)\n\nDonate For Me : \n\n⭔ 𝙉𝙖𝙣𝙖𝙙 𝙖𝙬𝙝` }, { quoted: m })
            }
            break
            case 'sc': {
                m.reply('*Script Bot :*\nhttps://www.instagram.com/nanadstoreee')
            }
            break
...
break
		...
		let { webp2mp4File } = require('./lib/uploader')
            ...
            let { toAudio } = require('./lib/converter')
            let audio = await toAudio(media, 'mp4')
            kagura.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By 𝙉𝙖𝙣𝙖𝙙 𝙖𝙬𝙝 Official.mp3`}, { quoted : m })
            }
            break
...
`
                let btn = [{
                                urlButton: {
                                    displayText: 'Source Code',
                                    url: 'https://www.instagram.com/nanadstoreee'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
