...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                kagura.sendMessage(m.chat, { image: { url: 'https://telegra.ph/DONASI-06-05' }, caption: `*Hai Kak ${m.pushName}*\n\n Harga Sewa Bot\n⭔ 5k Per Group via qris\n⭔ 10k via pusa\n\n Premium Price Bot\n⭔ 8k per User\n\nPayment can be via qris/pulsa\n\nFor more details, you can chat with the owner\nhttps://wa.me/6289684271435 (Owner)\n\nDonate For Me : \n\n⭔ RESYA BOT` }, { quoted: m })
            }
            break
            case 'sc': {
...
break
		...
		let { webp2mp4File } = require('./lib/uploader')
            ...
            let { toAudio } = require('./lib/converter')
            let audio = await toAudio(media, 'mp4')
            kagura.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By Resya Official.mp3`}, { quoted : m })
            }
            break
...
`
                let btn = [{
                                urlButton: {
                                    displayText: 'Source Code',
                                    url: 'https://www.instagram.com/resyagans19'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
                                    phoneNumber: '+62 896-8427-1435'
                                }
                            },{
                                quickReplyButton: {
                                    displayText: 'Status Bot',
                        ...
                        kagura.send5ButImg(m.chat, anu, `© SEWA BOT 5K`, global.thumb, btn)
                        } else if (setbot.templateGif) {
                        kagura.send5ButGif(m.chat, anu, `© SEWA BOT 5K`, global.visoka, btn)
                        } else if (setbot.templateVid) {
                        kagura.send5ButVid(m.chat, anu, `© SEWA BOT 5K`, global.visoka, btn)
                        } else if (setbot.templateMsg) {
                        kagura.send5ButMsg(m.chat, anu, `© SEWA BOT 5K`, btn)
                        }
                     }
            break
            default:
