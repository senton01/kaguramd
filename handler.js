...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                kagura.sendMessage(m.chat, { image: { url: 'https://i.postimg.cc/cJG2gC1S/20220612-221836.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n Harga Sewa Bot\n⭔ PERMANEN 7k Per Group\n⭔PERMINGGU 5k Per Group\n\n Premium Price Bot\n⭔ 8k per User\n\n📍PAYMENT DANA/QRIS/GOPAY\n\nFor more details, you can chat with the owner\nhttps://wa.me/6281914806147 (Owner)\n⭔INSTAGRAM http://www.instagram.com/baron_store01 (Testi)\n\nDonate For Me : \n\n⭔ CODE - X` }, { quoted: m })
            }
            break
            case 'sc': {
                m.reply('*Script Bot :*\nhttps://www.instagram.com/baron_store01')
            }
            break
...
break
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'http://www.instagram.com/baron_store01'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
                                    phoneNumber: ' +62 819-1480-6147'
                                }
                            }, {
                                quickReplyButton: {
		...
		let { webp2mp4File } = require('./lib/uploader')
            ...
            let { toAudio } = require('./lib/converter')
            let audio = await toAudio(media, 'mp4')
            kagura.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By CODE - X Official.mp3`}, { quoted : m })
            }
            break
...
`
                let btn = [{
                                urlButton: {
                                    displayText: 'INSTAGRAM',
                                    url: 'https://www.instagram.com/baron_store01'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
